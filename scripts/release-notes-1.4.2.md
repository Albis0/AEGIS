...
> **Çoğu kullanıcı için önerilen indirme:** `AEGIS-Setup-1.4.2.exe` — kurulum sihirbazıyla gelir, masaüstü/başlat menüsü kısayolu oluşturur ve otomatik güncelleme alır. Sıradan kullanıcılar bunu indirmeli.
>
> Kurulum istemeyen / taşınabilir kullanım için: `AEGIS-1.4.2.exe` (portable — kurulum yapmadan doğrudan çalışır).
...
### Kurulum
1. `AEGIS-Setup-1.4.2.exe` indir ve çalıştır.
