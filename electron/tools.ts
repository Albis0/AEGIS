...
const spotifySchemas: ChatCompletionTool[] = [
    ...
    // Artists
    {type:"function",function:{name:"spotify_get_artist",description:"Sanatçı bilgilerini getir (takipçi, popülerlik, türler). Sanatçı ID'si gerekir — isim verildiyse önce spotify_search ile ara ve dönen sonuçtan sanatçı ID'sini al.",parameters:{type:"object",properties:{id:{type:"string",description:"Spotify sanatçı ID'si (ör: 4Z8W4fKeB5YxbusRsdQVPb). İsim verilmişse önce spotify_search çağır."}},required:["id"],additionalProperties:false}}},
    {type:"function",function:{name:"spotify_artist_top_tracks",description:"Sanatçının en popüler şarkılarını listele. Sanatçı ID'si gerekir — kullanıcı isim verdiyse önce spotify_search ile sanatçıyı ara, dönen sonuçtan artist_id al, sonra bu aracı çağır.",parameters:{type:"object",properties:{id:{type:"string",description:"Spotify sanatçı ID'si. Sadece isim varsa önce spotify_search çağır."}},required:["id"],additionalProperties:false}}},
    {type:"function",function:{name:"spotify_artist_albums",description:"Sanatçının albümlerini ve single'larını listele. ID gerekir — isim verildiyse önce spotify_search ile ara.",parameters:{type:"object",properties:{id:{type:"string",description:"Spotify sanatçı ID'si. İsim varsa önce spotify_search çağır."}},required:["id"],additionalProperties:false}}},
    {type:"function",function:{name:"spotify_related_artists",description:"Bir sanatçıya benzer sanatçıları bul. ID gerekir — isim verildiyse önce spotify_search ile ara.",parameters:{type:"object",properties:{id:{type:"string",description:"Spotify sanatçı ID'si. İsim varsa önce spotify_search çağır."}},required:["id"],additionalProperties:false}}},
    ...
    // Follow
    {type:"function",function:{name:"spotify_follow_artist",description:"Bir sanatçıyı takip et. Sanatçı ID'si gerekir — kullanıcı isim verdiyse önce spotify_search ile sanatçıyı ara, dönen sonuçtan ID'yi al, ardından bu aracı çağır.",parameters:{type:"object",properties:{id:{type:"string",description:"Spotify sanatçı ID'si. İsim verilmişse önce spotify_search çağır."}},required:["id"],additionalProperties:false}}},
    {type:"function",function:{name:"spotify_unfollow_artist",description:"Bir sanatçıyı takipten çıkar. Sanatçı ID'si gerekir — kullanıcı isim verdiyse önce spotify_search ile ara.",parameters:{type:"object",properties:{id:{type:"string",description:"Spotify sanatçı ID'si. İsim verilmişse önce spotify_search çağır."}},required:["id"],additionalProperties:false}}},
