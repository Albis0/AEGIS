...
contextBridge.exposeInMainWorld("jarvis", {
    ...
    reportSubmit: (title: string, description: string, screenshot?: string) => ipcRenderer.invoke("report-submit", {title, description, screenshot}),
    reportPendingCount: () => ipcRenderer.invoke("report-pending-count"),
    reportCapture: () => ipcRenderer.invoke("report-capture"),
