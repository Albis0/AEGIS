        ...
        >
            ...
            <div className="shrink-0 px-5 pb-4">
                <div className="flex items-center gap-3 px-4 py-2.5 rounded-xl border" style={{borderColor: "rgba(var(--hud),0.2)", background: "rgba(var(--hud),0.04)"}}>
                    ...
                    <button onClick={onSend} disabled={streaming || !input.trim()} className="px-3 py-1 rounded border text-[10px] tracking-widest disabled:opacity-30 transition hover:brightness-125" style={{fontFamily: "Orbitron, sans-serif", color: "rgb(var(--hud))", borderColor: "rgba(var(--hud),0.25)"}}>
                        SEND
                    </button>
                </div>
            </div>
